...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  var audioModuleManager = new _AudioModuleManager2.default(audioCtx);

	  // audio patch for the additive synth
	  var additorAudioPatch = _AudioModuleManager2.default.createAudioPatch({
	    modules: {
	      "additiveSynth": audioModuleManager.createAdditiveSynth(),
	      "filter": audioModuleManager.createBiquadFilter(),
	      "delay": audioModuleManager.createStereoFeedbackDelay(),
	      "output": audioModuleManager.createChannelStrip(),
	      "destination": audioModuleManager.createDestination()
	    },

	    connections: [["additiveSynth", "filter", "delay", "output", "destination"]]
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AudioModuleUtil = __webpack_require__(3);

	var _AudioModuleUtil2 = _interopRequireDefault(_AudioModuleUtil);

	var _AdditiveSynthAudioModule = __webpack_require__(4);

	var _AdditiveSynthAudioModule2 = _interopRequireDefault(_AdditiveSynthAudioModule);

	var _BiquadFilterAudioModule = __webpack_require__(12);

	var _BiquadFilterAudioModule2 = _interopRequireDefault(_BiquadFilterAudioModule);

	var _ChannelStrip = __webpack_require__(8);

	var _ChannelStrip2 = _interopRequireDefault(_ChannelStrip);

	var _DestinationAudioModule = __webpack_require__(13);

	var _DestinationAudioModule2 = _interopRequireDefault(_DestinationAudioModule);

	var _Envelope = __webpack_require__(10);

	var _Envelope2 = _interopRequireDefault(_Envelope);

	var _StereoFeedbackDelay = __webpack_require__(14);
	  ...
	  return {
	    ...
	    createAudioPatch: function createAudioPatch(initObj) {
	      ...
	      try {
	        ...
	        if (_typeof(initObj.modules) === "object") {

	          Object.keys(initObj.modules).forEach(function (key) {
	            var audioModuleSpecArray = audioModules[key];

	            if ((typeof audioModuleSpecArray === 'undefined' ? 'undefined' : _typeof(audioModuleSpecArray)) === "object" && Array.isArray(audioModuleSpecArray) && typeof audioModuleSpecArray[0] === "string") {

	              // the first string in the specification defines the type of module
	              var audioModuleType = audioModuleSpecArray[0];

	              // if the audio module types are specified as strings, create the corresponding modules
	              if (typeof audioModuleSpecArray === "string") {

	                // the second argument is the name used to identify this module
	                var audioModuleName = audioModuleSpecArray[1];
	        ...
	        if (_typeof(initObj.connectionPaths) === "object" && Arrays.isArray(initObj.connectionPaths)) {
	          initObj.connectionPaths.forEach(function (connectionPath) {
	     ...
	     */
	    createAdditiveSynth: function createAdditiveSynth() {
	      return new _AdditiveSynthAudioModule2.default(audioCtx);
	    },
	    ...
	    createBiquadFilter: function createBiquadFilter() {
	      return new _BiquadFilterAudioModule2.default(audioCtx);
	    },

	    /**
	     * Create a Channel Strip Audio Module
	     */
	    createChannelStrip: function createChannelStrip() {
	      return new _ChannelStrip2.default(audioCtx);
	    },
	    ...
	    createDestination: function createDestination() {
	      return new _DestinationAudioModule2.default(audioCtx);
	    },

	    /**
	     * Create an Envelope Audio Module
	     */
	    createEnvelope: function createEnvelope() {
	      return new _Envelope2.default(audioCtx);
	    },

	    /**
	     * Create a Stereo Feedback Delay Audio Module
	     */
	    createStereoFeedbackDelay: function createStereoFeedbackDelay() {
	      return new _StereoFeedbackDelay2.default(audioCtx);
	    }
	  };
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AudioModule2 = __webpack_require__(5);

	var _AudioModule3 = _interopRequireDefault(_AudioModule2);

	var _AdditiveSynth = __webpack_require__(6);
	...
	var AdditiveSynthAudioModule = function (_AudioModule) {
	  _inherits(AdditiveSynthAudioModule, _AudioModule);

	  function AdditiveSynthAudioModule(audioCtx) {
	    _classCallCheck(this, AdditiveSynthAudioModule);

	    var _this = _possibleConstructorReturn(this, (AdditiveSynthAudioModule.__proto__ || Object.getPrototypeOf(AdditiveSynthAudioModule)).call(this, audioCtx));

	    _this.prototype = (0, _AdditiveSynth2.default)({
	      audioCtx: audioCtx
	    });
	    return _this;
	  }

	  return AdditiveSynthAudioModule;
	}(_AudioModule3.default);
...
/***/ (function(module, exports) {
	...
	var AudioModule = function AudioModule(audioCtx) {
	  ...
	  return {
	     ...
	     */
	    connect: function connect(destination, outputIndex, inputIndex) {
	     ...
	     */
	    disconnect: function disconnect(destination, outputIndex, inputIndex) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AdditiveSynthVoice = __webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Overtone = __webpack_require__(11);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _StereoPannerShim = __webpack_require__(9);
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var BiquadFilterAudioModule = function (_AudioModule) {
	  _inherits(BiquadFilterAudioModule, _AudioModule);

	  function BiquadFilterAudioModule(audioCtx) {
	    _classCallCheck(this, BiquadFilterAudioModule);

	    return _possibleConstructorReturn(this, (BiquadFilterAudioModule.__proto__ || Object.getPrototypeOf(BiquadFilterAudioModule)).call(this, audioCtx));
	  }

	  return BiquadFilterAudioModule;
	}(_AudioModule3.default);

	exports.default = BiquadFilterAudioModule;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DestinationAudioModule = function (_AudioModule) {
	  _inherits(DestinationAudioModule, _AudioModule);

	  function DestinationAudioModule(audioCtx) {
	    _classCallCheck(this, DestinationAudioModule);

	    var _this = _possibleConstructorReturn(this, (DestinationAudioModule.__proto__ || Object.getPrototypeOf(DestinationAudioModule)).call(this, audioCtx));

	    _this.input.connect(_this.output);
	    _this.output.connect(audioCtx.destination);
	    return _this;
	  }

	  return DestinationAudioModule;
	}(_AudioModule3.default);

	exports.default = DestinationAudioModule;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Histogram = __webpack_require__(17);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _EnvelopeGraph = __webpack_require__(19);

	var _EnvelopeGraph2 = _interopRequireDefault(_EnvelopeGraph);

	var _DropMenu = __webpack_require__(20);

	var _DropMenu2 = _interopRequireDefault(_DropMenu);

	var _Numberbox = __webpack_require__(21);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Dial = __webpack_require__(23);
