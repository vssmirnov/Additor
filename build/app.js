...
define(['require', 'Overtone', 'Envelope', 'ChannelStrip', 'AdditiveSynthVoice', 'AdditiveSynth', 'util', 'LiveKeyboard', 'EnvelopeGraph', 'LiveDial', 'LiveSlider', 'Histogram', 'LiveMeter', 'LiveDropMenu', 'StereoFeedbackDelay', 'DragNumberbox', 'additorPresets'], function (require, Overtone, Envelope, ChannelStrip, AdditiveSynthVoice, AdditiveSynth, util, LiveKeyboard, EnvelopeGraph, LiveDial, LiveSlider, Histogram, LiveMeter, LiveDropMenu, StereoFeedbackDelay, DragNumberbox, additorPresets) {
  'use strict';
  ...
  var app = function app() {
    ...
    /* Preset saving */
    var presetNameInput = document.querySelector('#preset-name');
    var savePresetBtn = document.querySelector('#additor .main-header .btn.save-preset');
    ...
    function savePresetXHR(preset) {
      var url = 'http://127.0.0.1:5984/additor_presets/all_presets';
      ...
      getXHR.onreadystatechange = function () {
        ...
        if (getXHR.status.toString().match(/^2\d\d$/) !== null) {
          var parsedData = JSON.parse(getXHR.response);
